...
def verify(img1_path, img2_path = '', model_name = 'VGG-Face', max_threshold_to_verify = 0.45, distance_metric = 'cosine', model = None, enforce_detection = True, detector_backend = 'opencv', align = True, prog_bar = True, normalization = 'base'):
    print("Verigy")
    exit(0)
    """
            ...
            for i in  model_names:
                ...
                for j in metrics:
                    ...
                    if model_name != 'Ensemble':
                        ...
                        # if max_threshold_to_verify is not None:
                        #     threshold = max_threshold_to_verify
