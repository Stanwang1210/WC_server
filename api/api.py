...
#             resp_obj = detectWrapper(req, trx_id)
#     elif tf_version == 2:
#         resp_obj = detectWrapper(req, trx_id)
...
#     return resp_obj
# def detectWrapper(req, trx_id = 0):

#     resp_obj = jsonify({'success': False})
# #     print(resp_obj)

#     model_name = "VGG-Face"; distance_metric = "cosine"; detector_backend = "opencv"; max_threshold_to_verify=0.4;
#     if "max_threshold_to_verify" in list(req.keys()):
#         max_threshold_to_verify = req["max_threshold_to_verify"]
...
#     try:
#         resp_obj = DeepFace.detectFace()(instances
#             , model_name = model_name
#             # , distance_metric = distance_metric
#             # , detector_backend = detector_backend
#             # , max_threshold_to_verify = max_threshold_to_verify
#         )
